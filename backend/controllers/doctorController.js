...
exports.updateDoctor = async (req, res) => {
    try {
        ...
        await DoctorModel1.findByIdAndUpdate(doctorId, doctorData);
        await DoctorModel2.findByIdAndUpdate(doctorId, doctorData);
...
exports.deleteDoctor = async (req, res) => {
    try {
        ...
        await DoctorModel1.findByIdAndDelete(doctorId);
        await DoctorModel2.findByIdAndDelete(doctorId);
