...
exports.updateRoom = async (req, res) => {
    try {
        ...
        await RoomModel1.findByIdAndUpdate(roomId, roomData);
        await RoomModel2.findByIdAndUpdate(roomId, roomData);
...
exports.deleteRoom = async (req, res) => {
    try {
        ...
        await RoomModel1.findByIdAndDelete(roomId);
        await RoomModel2.findByIdAndDelete(roomId);
