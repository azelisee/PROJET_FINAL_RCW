...
const PatientDetail = () => {
    ...
    const handlePatientEditClick = (e, id) => {
        e.preventDefault();
        if (verifyAccess()) {
    ...
    return (
        <div className="patient-detail-container">
            ...
            <center><Link to="#" onClick={(e) => handlePatientEditClick(e, patient._id)} className="btn" style={{ width: '150px' }}>Edit Patient</Link></center>
        </div>
    );
};
